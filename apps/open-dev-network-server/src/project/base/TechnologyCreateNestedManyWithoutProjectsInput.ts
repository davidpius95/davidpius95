...
@InputType()
class TechnologyCreateNestedManyWithoutProjectsInput {
...
export { TechnologyCreateNestedManyWithoutProjectsInput as TechnologyCreateNestedManyWithoutProjectsInput };
