...
@InputType()
class RepositoryCreateNestedManyWithoutProjectsInput {
...
export { RepositoryCreateNestedManyWithoutProjectsInput as RepositoryCreateNestedManyWithoutProjectsInput };
